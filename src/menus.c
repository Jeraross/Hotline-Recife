...
void displayMenu() {
    ...
    char *ascii_art[] = {
        ...
        "\x1b[34m       ~ ~             \x1b[0m\x1b[33m$$$$$\x1b[0m\x1b[34m     ~    ~  ~        ~         ~      ~    ~  ~        ~          ~   ~       ~          ~     ~     ~   ~       ~          \x1b[0m",
        "\x1b[34m  ~            ~     ~ \x1b[0m\x1b[33m$$$$$\x1b[0m\x1b[34m       ~  ~       ~        ~        ~        ~         ~              ~    ~  ~        ~         ~      ~    ~  ~        ~   \x1b[0m",
        "_______________________\x1b[33m$$$$$\x1b[0m________________________________________________________________________________________________________________________________",
        "                       \x1b[33m$$$$$\x1b[0m                                                                      ",
        "                       \x1b[33m$$$$$\x1b[0m                                                                      ",
        "                      \x1b[33m$$$$$$$\x1b[0m                                                                     ",
...
void printCreditsArt(){
    ...
    printf("╚═╝  ╚═╝╚══════╝╚═╝  ╚═══╝╚═╝  ╚═╝╚═╝ ╚══▀▀═╝  ╚═════╝ ╚══════╝     \n");
    printf("                                                                    \n");
    printf("Menção honrosa aos nossos amigos do DuneII pela competição FODA <3  \n");
}